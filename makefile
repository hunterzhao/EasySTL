stl : main.o listTest.o vectorTest.o alloc.o dequeTest.o heapTest.o
	g++ -g -std=c++11 -o stl main.o listTest.o vectorTest.o alloc.o dequeTest.o heapTest.o
...
clean : 
	rm stl main.o listTest.o vectorTest.o alloc.o dequeTest.o heapTest.o
